...
import { Nav, Navbar, Form, NavDropdown, FormControl, Button, Container, Jumbotron, Row, Col, Image,Tab,Tabs,Sonnet } from "react-bootstrap"
  ...
  render () {
    return (
      ...
      <div className="row">
        ...
        <p className="text-left"> The first step to connect to other software enigneers </p>
        </div>
      </div>
